    ...
    <div className="w-full bg-custom-background1  bg-cover bg-center py-12 mb-9">
      <div className="container mx-auto flex ">
        <div className="text-center p-4">
          <div
            className=" ml-[75px] flex justify-center items-center h-24 w-24 mb-4 bg-white 
        ...
        <div className="text-center p-4">
          <div className="group hover:bg-slate-700 flex ml-[75px] justify-center items-center h-24 w-24 mb-4 bg-white rounded-full shadow-lg transition-transform transform hover:scale-110">
