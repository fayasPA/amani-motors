...
function CarCards() {
  ...
  async function get_latest_vehicles() {
    try {
      ...
      console.log("***********LATEST",response.data.vehicles);
              ...
              <div key={index} className=" p-4 rounded-lg shadow-lg">
                ...
                <div className="flex justify-between items-center text-sm text-gray-700 mb-2">
                  <div className="flex items-center gap-2 justify-center">
                    ...
                    <FaCalendarAlt size={15} color='grey'/>
                    <span className='text-zinc bg-gray'>{product.year}</span>
                  </div>
                  {/* <div className="flex items-center">
                    ...
                    <span className='text-zinc'>{product.fuel_type}</span>
                  </div> */}
                  <div className="flex items-center">
                    ...
                    <span className='text-zinc'>{product.kms} KMS</span>
                  </div>
                </div>
                <div className="text-center font-semibold text-lg text-zinc mb-4">{getNumberToCurrencyText(product.price)}</div>
